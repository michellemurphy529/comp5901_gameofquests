...
public class GameAcceptanceTest {
    ...
    void A_test_JP_scenario() {
        ...
        */
        ...
        for (int i = 0; i < 12; i++) {
            game.gameLogic.discardCard(p1ID, adventureDeck, p1.getHand().get(0));
            game.gameLogic.discardCard(p2ID, adventureDeck, p2.getHand().get(0));
            game.gameLogic.discardCard(p3ID, adventureDeck, p3.getHand().get(0));
            game.gameLogic.discardCard(p4ID, adventureDeck, p4.getHand().get(0));
        }
        ...
        */
        ...
        game.getEventDeck().getDeck().add(0, q4);
        ...
        adventureDeck.getDeck().add(0, new WeaponCard("H",10));
        adventureDeck.getDeck().add(0, new FoeCard(40));
        adventureDeck.getDeck().add(0, new WeaponCard("S",10));
        adventureDeck.getDeck().add(0, new WeaponCard("B",15));
        adventureDeck.getDeck().add(0, new WeaponCard("L",20));
        adventureDeck.getDeck().add(0, new WeaponCard("S",10));
        adventureDeck.getDeck().add(0, new FoeCard(5));
        adventureDeck.getDeck().add(0, new WeaponCard("B",15));
        adventureDeck.getDeck().add(0, new WeaponCard("S",10));
        adventureDeck.getDeck().add(0, new FoeCard(10));
        adventureDeck.getDeck().add(0, new WeaponCard("L",20));

        //Rig adventure deck to draw the right cards
        adventureDeck.getDeck().add(0, new WeaponCard("L",20));
        adventureDeck.getDeck().add(0, new FoeCard(30));
        adventureDeck.getDeck().add(0, new WeaponCard("S",10));
        adventureDeck.getDeck().add(0, new WeaponCard("B",15));
        adventureDeck.getDeck().add(0, new WeaponCard("L",20));
        adventureDeck.getDeck().add(0, new WeaponCard("L",20));
