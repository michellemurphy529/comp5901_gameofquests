...
class GameTest {
    ...
    void RESP_008_test_001() {
        ...
        game.getEventDeck().getDeck().add(0, card1);
...
//        assertEquals(lastCardDrawn, cardInPlayerHand);
    ...
    void RESP_010_test_001() {
        ...
        eventDeck.cards.add(0, plagueCard);
...
//    }
    ...
    void RESP_012_test_001() {
        ...
        eventDeck.cards.add(0, queenFavorCard);
    ...
    void RESP_013_test_001() {
        ...
        eventDeck.cards.add(0, prosperity);
    ...
    void RESP_013_test_002() {
        ...
        for (int i = 0; i < 2; i++) {
            Card card1 = game.gameLogic.getPlayerHand("P1").get(0);
            Card card2 = game.gameLogic.getPlayerHand("P2").get(0);
            Card card3 = game.gameLogic.getPlayerHand("P3").get(0);
            Card card4 = game.gameLogic.getPlayerHand("P4").get(0);
    ...
    void RESP_041_test_001() {
        ...
        game.gameLogic.getEventDeck().cards.add(0, questCard);
...
//    }
    ...
    void RESP_043_test_002() {
        ...
        ArrayList<Card> attackCards = game.promptPlayerToSelectCardOrQuit(playerID);
        assertEquals("Quit", game.gameDisplay.lastInput);
        assertEquals(card1, attackCards.get(0));
    ...
    void RESP_027_test_001() {
        ...
        Card card1 = game.gameLogic.getPlayerHand(participantID).get(0);
        game.discardAdventureCard(participantID, card1);
        Card card2 = game.gameLogic.getPlayerHand(participantID).get(0);
        game.discardAdventureCard(participantID, card2);
        Card card3 = game.gameLogic.getPlayerHand(participantID).get(0);
    ...
    void RESP_021_test_002() {
        ...
        game.getEventDeck().getDeck().add(0, new QuestCard(2));
...
//        RESP_024_test_002();
    ...
    void RESP_025_test_001() {
        ...
        game.gameLogic.getPlayer("P1").getHand().remove(0);
        game.gameLogic.getPlayer("P3").getHand().remove(0);
        game.gameLogic.getPlayer("P4").getHand().remove(0);
...
//        RESP_025_test_002();
    ...
    void RESP_026_test_001() {
        ...
        //force game not to trim hands when receiving adventure card by removing a card
        game.gameLogic.getPlayer("P1").getHand().remove(0);
        game.gameLogic.getPlayer("P2").getHand().remove(0);
        game.gameLogic.getPlayer("P3").getHand().remove(0);
        game.gameLogic.getPlayer("P4").getHand().remove(0);
        game.gameLogic.getPlayer("P1").getHand().remove(0);
        game.gameLogic.getPlayer("P2").getHand().remove(0);
...
//        RESP_028_test_003();
    ...
    void RESP_029_test_003() {
        ...
        assertEquals(card1.getType(), attackHand1.get(0).getType());
        assertEquals(card2.getType(), attackHand2.get(0).getType());
        assertEquals(card3.getType(), attackHand2.get(1).getType());
        assertEquals(card4.getType(), attackHand3.get(0).getType());
    }
...
//        RESP_029_test_004();
    ...
    void RESP_032_test_002() {
        ...
        assertEquals(card1.getType(), game.getAdventureDeck().getDiscardPile().get(0).getType());
        assertEquals(card2.getType(), game.getAdventureDeck().getDiscardPile().get(1).getType());
        assertEquals(card3.getType(), game.getAdventureDeck().getDiscardPile().get(2).getType());
        assertEquals(card4.getType(), game.getAdventureDeck().getDiscardPile().get(3).getType());
    }
...
//    }
    ...
    void RESP_023_test_002() {
        ...
        //draw Quest card
        Card questCard = new QuestCard(4);
        game.getEventDeck().getDeck().add(0, questCard);
...
//        for (String playerID : game.getPlayerIDs()) {
//            game.gameLogic.getPlayer(playerID).getHand().remove(0);
//        }
//
...
//    @Test
//    @DisplayName("RESP-032-Test-003: System discards all cards used by participants for a stage, once resolved")
//    void RESP_032_test_003() {
//        //Test helpers
//        TestHelpers helper = new TestHelpers();
//        Game game = new Game(new GameLogic(), new GameDisplay());
//        helper.setUpForTestGeneral(game);
...
//        HashMap<String,ArrayList<Card>> attackHands;
//
//        game.beginQuest();
//
//        //Test attackHands after discarding occurs
...
//    }
    ...
    void RESP_033_test_001() {
        ...
        game.getAdventureDeck().getDeck().add(0, new FoeCard(50));
        game.getAdventureDeck().getDeck().add(0, new FoeCard(15));
        game.getAdventureDeck().getDeck().add(0, new FoeCard(10));
...
//    }
    ...
    void RESP_044_test_003() {
        ...
        assertEquals(1, attackCards.size());
        AdventureCard aCard1 = (AdventureCard) attackCards.get(0);
